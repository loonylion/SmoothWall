...
# dhcpwol
'dhcpwol-link-tip1' => 'Go to the SW Forums',
'dhcpwol-link-tip2' => 'Mod thread',
'dhcpwol-custom gateway' => 'Custom gateway:',
'dhcpwol-custom gateway-tip' => 'If blank, then the default gateway will be used, i.e. the IP of the selected interface.',
'dhcpwol-clean-leases' => 'Clean leases',
'dhcpwol-deny unknown' => 'Deny unknown clients:',
'dhcpwol-IP address not' => 'IP address not within selected interface network range',
'dhcpwol-wakeup' => 'Attempting to power on selected host',
'dhcpwol-select' => 'Cannot save without selecting first.',
'dhcpwol-confirm' => 'Are you sure you want to clean all current dynamic leases',
'dhcpwol-prefsc' => 'Preferences:',
'dhcpwol-globalc' => 'Global settings:',
'dhcpwol-ifc' => 'Interface:',
'dhcpwol-error' => 'ERROR',
'dhcpwol-show conns' => 'Show Connections',
'dhcpwol-show dyn' => 'Show dynamic leases',
'dhcpwol-show stale' => 'Show stale leases',
'dhcpwol-show state' => 'Show static assignments state',
'dhcpwol-update oui' => 'Update OUI Monthly',
'dhcpwol-consc' => 'Connections:',
'dhcpwol-dyn' => 'Current dynamic leases:',
'dhcpwol-nohost' => 'Please enter a host name',
'dhcpwol-invalidhost' => 'Host name is invalid. Must start with a letter and use only letters, numbers, dots, "-" and "_".',
